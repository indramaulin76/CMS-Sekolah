                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-surface-dark rounded-xl p-6 shadow-lg">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="<?php echo e($settings->tiktok_url); ?>" target="_blank" class="w-12 h-12 bg-gray-900 text-white rounded-lg flex items-center justify-center hover:bg-gray-800 transition-colors" style="background-color: #000000;">
