<x-layouts.app :settings="$settings ?? null">
    <div class="container mx-auto px-4 lg:px-8 py-16">
        <div class="max-w-3xl mx-auto text-center">
            <div class="mb-8 p-8 bg-green-50 dark:bg-green-900/20 rounded-2xl border border-green-100 dark:border-green-800">
                ...
                <h1 class="text-3xl font-bold font-display text-gray-800 dark:text-white mb-2">
                    Pendaftaran Berhasil!
                </h1>
                <p class="text-green-600 dark:text-green-400 font-medium text-lg mb-6">
