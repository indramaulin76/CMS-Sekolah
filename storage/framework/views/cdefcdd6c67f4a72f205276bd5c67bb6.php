...
<body>
    <div class="card">
        ...
        <div class="title-bar">
            KARTU BUKTI PENDAFTARAN PPDB <?php echo e($registration->period->academic_year ?? date('Y')); ?>
        ...
        <div class="content">
                ...
                <div class="info-section">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($registration->birth_place); ?>, <?php echo e($registration->birth_date?->format('d F Y')); ?></td>
                        </tr>
                        <tr>
                            <td>Agama</td>
                            <td><?php echo e($registration->religion); ?></td>
                        </tr>
                        <tr>
                            <td>NISN</td>
            ...
            <div class="info-section">
                ...
                <table>
                    <tr>
                        <td>Asal Sekolah</td>
                        <td><?php echo e($registration->previous_school); ?></td>
                    </tr>
                    <tr>
                        <td>No. HP Siswa</td>
            ...
            <div class="info-section">
                ...
                <table>
                    <tr>
                        ...
                        <td><?php echo e($registration->parent_name); ?></td>
                    </tr>
                    <tr>
                        <td>No. HP Orang Tua</td>
                        <td><?php echo e($registration->parent_phone); ?></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td><?php echo e($registration->parent_address); ?></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="signature">
                <div class="date">Jakarta, <?php echo e(now()->format('d F Y')); ?></div>
        ...
        <div class="footer">
            ...
            <div class="right">
                Status: <strong style="color: #f59e0b;"><?php echo e($registration->status?->getLabel() ?? 'Pending'); ?></strong>
            </div>
        </div>
    </div>
    <script>
...
<?php /**PATH /var/www/html/resources/views/ppdb/kartu-pendaftaran.blade.php ENDPATH**/ ?>