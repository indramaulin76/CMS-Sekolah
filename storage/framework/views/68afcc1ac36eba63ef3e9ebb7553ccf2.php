...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Profil Sekolah','icon' => 'fas fa-school']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Profil Sekolah','icon' => 'fas fa-school']); ?>
    ...
    <div class="container mx-auto px-4 lg:px-8 py-12">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white dark:bg-surface-dark rounded-xl shadow-xl p-6 md:p-10 border-t-4 border-secondary">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($page && $page->content): ?>
            ...
            <div class="mt-8 text-center">
                <a href="<?php echo e(route('pages.kontak')); ?>" class="inline-flex items-center px-8 py-3 bg-primary text-white rounded-lg hover:bg-blue-700 transition-colors shadow-lg font-bold text-lg">
