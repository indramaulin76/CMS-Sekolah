...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-header','data' => ['title' => 'Pengumuman PPDB','subtitle' => 'Informasi pengumuman hasil seleksi PPDB','icon' => 'fas fa-bullhorn']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pengumuman PPDB','subtitle' => 'Informasi pengumuman hasil seleksi PPDB','icon' => 'fas fa-bullhorn']); ?>
